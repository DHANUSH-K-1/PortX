...
`,ur=u=>{const f=u*u*4,n=new Float32Array(f);for(let m=0;m<u*u;m++){const d=m*4,h=Math.random(),k=Math.random(),w=h*2*Math.PI,L=Math.acos(2*k-1),A=2;n[d]=A*Math.sin(L)*Math.cos(w),n[d+1]=A*Math.sin(L)*Math.sin(w),n[d+2]=A*Math.cos(L),n[d+3]=1}return n};function dr(){const u=st(K,K,{minFilter:Ee,magFilter:Ee,format:Be,type:Ie}),f=st(K,K,{minFilter:Ee,magFilter:Ee,format:Be,type:Ie}),n=c.useRef(u),m=c.useMemo(()=>{const C=ur(K),N=new Yt(C,K,K,Be,Ie);return N.needsUpdate=!0,N},[]),d=c.useRef(null),h=c.useRef(null),k=c.useRef(null),w=c.useMemo(()=>new Vt,[]),L=c.useMemo(()=>new Ht(-1,1,1,-1,-1,1),[]),A=c.useRef(new at(0,0,0)),V=c.useMemo(()=>{const C=new Wt,N=new Float32Array(K*K*3);for(let P=0;P<K;P++)for(let F=0;F<K;F++){const z=(P*K+F)*3;N[z]=F/K,N[z+1]=P/K,N[z+2]=0}return C.setAttribute("position",new $t(N,3)),C},[]),G=c.useRef(!1),M=c.useRef(null);return qt(C=>{k.current&&(A.current.x=C.pointer.x*C.viewport.width/2,A.current.y=C.pointer.y*C.viewport.height/2,A.current.z=0),M.current&&(M.current.rotation.y=C.clock.elapsedTime*.05,M.current.rotation.x=Math.sin(C.clock.elapsedTime*.02)*.1);const N=n.current,P=n.current===u?f:u;d.current&&(G.current?d.current.uniforms.positions.value=N.texture:(d.current.uniforms.positions.value=m,G.current=!0),d.current.uniforms.uTime.value=C.clock.elapsedTime,d.current.uniforms.uMouse.value.lerp(A.current,.1)),C.gl.setRenderTarget(P),C.gl.render(w,L),C.gl.setRenderTarget(null),n.current=P,h.current&&(h.current.uniforms.uPositions.value=P.texture,h.current.uniforms.uTime.value=C.clock.elapsedTime)}),e.jsxs(e.Fragment,{children:[Jt(e.jsxs("mesh",{children:[e.jsx("planeGeometry",{args:[2,2]}),e.jsx("shaderMaterial",{ref:d,vertexShader:lr,fragmentShader:nr,uniforms:{positions:{value:m},uTime:{value:0},uMouse:{value:new at}}})]}),w),e.jsxs("points",{ref:M,children:[e.jsx("bufferGeometry",{attach:"geometry",...V}),e.jsx("shaderMaterial",{ref:h,vertexShader:ir,fragmentShader:cr,uniforms:{uPositions:{value:null},uTime:{value:0}},transparent:!0,depthWrite:!1,blending:Zt})]}),e.jsxs("mesh",{ref:k,visible:!1,children:[e.jsx("planeGeometry",{args:[100,100]}),e.jsx("meshBasicMaterial",{})]})]})}function pr({SIM_RESOLUTION:u=128,DYE_RESOLUTION:f=1440,CAPTURE_RESOLUTION:n=512,DENSITY_DISSIPATION:m=3.5,VELOCITY_DISSIPATION:d=2,PRESSURE:h=.1,PRESSURE_ITERATIONS:k=20,CURL:w=3,SPLAT_RADIUS:L=.2,SPLAT_FORCE:A=6e3,SHADING:V=!0,COLOR_UPDATE_SPEED:G=10,BACK_COLOR:M={r:.5,g:0,b:0},TRANSPARENT:C=!0,RAINBOW_MODE:N=!0,COLOR:P="#ff0000"}){const F=c.useRef(null),z=c.useRef(null);return c.useEffect(()=>{const S=F.current;if(!S)return;let R=!0;function B(){this.id=-1,this.texcoordX=0,this.texcoordY=0,this.prevTexcoordX=0,this.prevTexcoordY=0,this.deltaX=0,this.deltaY=0,this.down=!1,this.moved=!1,this.color=[0,0,0]}let T={SIM_RESOLUTION:u,DYE_RESOLUTION:f,DENSITY_DISSIPATION:m,VELOCITY_DISSIPATION:d,PRESSURE:h,PRESSURE_ITERATIONS:k,CURL:w,SPLAT_RADIUS:L,SPLAT_FORCE:A,SHADING:V,COLOR_UPDATE_SPEED:G,RAINBOW_MODE:N,COLOR:P},ee=[new B];const{gl:r,ext:j}=$(S);j.supportLinearFiltering||(T.DYE_RESOLUTION=256,T.SHADING=!1);function $(t){const o={alpha:!0,depth:!1,stencil:!1,antialias:!1,preserveDrawingBuffer:!1};let a=t.getContext("webgl2",o);const l=!!a;l||(a=t.getContext("webgl",o)||t.getContext("experimental-webgl",o));let x,b;l?(a.getExtension("EXT_color_buffer_float"),b=a.getExtension("OES_texture_float_linear")):(x=a.getExtension("OES_texture_half_float"),b=a.getExtension("OES_texture_half_float_linear")),a.clearColor(0,0,0,1);const y=l?a.HALF_FLOAT:x&&x.HALF_FLOAT_OES;let H,Y,ue;return l?(H=U(a,a.RGBA16F,a.RGBA,y),Y=U(a,a.RG16F,a.RG,y),ue=U(a,a.R16F,a.RED,y)):(H=U(a,a.RGBA,a.RGBA,y),Y=U(a,a.RGBA,a.RGBA,y),ue=U(a,a.RGBA,a.RGBA,y)),{gl:a,ext:{formatRGBA:H,formatRG:Y,formatR:ue,halfFloatTexType:y,supportLinearFiltering:b}}}function U(t,o,a,l){if(!Q(t,o,a,l))switch(o){case t.R16F:return U(t,t.RG16F,t.RG,l);case t.RG16F:return U(t,t.RGBA16F,t.RGBA,l);default:return null}return{internalFormat:o,format:a}}function Q(t,o,a,l){const x=t.createTexture();t.bindTexture(t.TEXTURE_2D,x),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MAG_FILTER,t.NEAREST),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),t.texImage2D(t.TEXTURE_2D,0,o,4,4,0,a,l,null);const b=t.createFramebuffer();return t.bindFramebuffer(t.FRAMEBUFFER,b),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,x,0),t.checkFramebufferStatus(t.FRAMEBUFFER)===t.FRAMEBUFFER_COMPLETE}class te{constructor(o,a){this.vertexShader=o,this.fragmentShaderSource=a,this.programs=[],this.activeProgram=null,this.uniforms=[]}setKeywords(o){let a=0;for(let x=0;x<o.length;x++)a+=Ct(o[x]);let l=this.programs[a];if(l==null){let x=W(r.FRAGMENT_SHADER,this.fragmentShaderSource,o);l=se(this.vertexShader,x),this.programs[a]=l}l!==this.activeProgram&&(this.uniforms=q(l),this.activeProgram=l)}bind(){r.useProgram(this.activeProgram)}}class re{constructor(o,a){this.uniforms={},this.program=se(o,a),this.uniforms=q(this.program)}bind(){r.useProgram(this.program)}}function se(t,o){let a=r.createProgram();return r.attachShader(a,t),r.attachShader(a,o),r.linkProgram(a),r.getProgramParameter(a,r.LINK_STATUS)||console.trace(r.getProgramInfoLog(a)),a}function q(t){let o=[],a=r.getProgramParameter(t,r.ACTIVE_UNIFORMS);for(let l=0;l<a;l++){let x=r.getActiveUniform(t,l).name;o[x]=r.getUniformLocation(t,x)}return o}function W(t,o,a){o=ae(o,a);const l=r.createShader(t);return r.shaderSource(l,o),r.compileShader(l),r.getShaderParameter(l,r.COMPILE_STATUS)||console.trace(r.getShaderInfoLog(l)),l}function ae(t,o){if(!o)return t;let a="";return o.forEach(l=>{a+="#define "+l+`
`}),a+t}const Z=W(r.VERTEX_SHADER,`
    ...
    `,de=W(r.FRAGMENT_SHADER,`
      ...
      `,j.supportLinearFiltering?null:["MANUAL_FILTERING"]),me=W(r.FRAGMENT_SHADER,`
        precision mediump float;
        precision mediump sampler2D;
        varying highp vec2 vUv;
